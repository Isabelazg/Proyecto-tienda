...
export const CreateRoleDialog = ({ isOpen, setIsOpen, onSubmit, isLoading = false }) => {
  ...
  return (
    <FormDialog
      ...
      description="Completa los siguientes campos para registrar un rol"
      onSubmit={handleFormSubmit}
      submitText={isLoading ? 'Creando...' : 'Crear Rol'}
      cancelText="Cancelar"
      maxWidth="max-w-3xl"
      isLoading={isLoading}
