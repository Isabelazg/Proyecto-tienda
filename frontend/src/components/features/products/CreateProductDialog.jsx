...
export const CreateProductDialog = ({
  ...
  const handleFormSubmit = (e) => {
    ...
    try {
      ...
      // Solo cerrar si el resultado indica éxito
  ...
  return (
    <FormDialog
      ...
      description="Completa los siguientes campos para registrar un producto"
      onSubmit={handleFormSubmit}
      submitText={isLoading ? "Creando..." : "Crear Producto"}
      cancelText="Cancelar"
      maxWidth="2xl"
      isLoading={isLoading}
