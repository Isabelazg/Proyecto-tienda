...
import { FormDialog, FormSelect, FormTextarea, FilterInput, FormSummaryCard, FormSectionTitle, FormScrollPanel, FormListContainer } from '@/components/common';
...
export const EditOrderDialog = ({
  ...
  return (
    <FormDialog
      ...
      title="Editar Pedido"
      description={order ? `Editando pedido #${order.id}` : 'Editar pedido'}
